...
(async function example() {
    ...
    try {
        ...
        console.log("--------------------------")
        let items = await driver.findElements(By.className('product column shadow hover-light'))
        ...
        let sticker = await driver.findElements(By.xpath('(//*["box"]/div/ul/li //div[@title])[' + i + ']'))
